...
class TestPreprocessingLogic:
    ...
    def test_basic_preprocessing(self, sample_data, mock_config):
        ...
        expected_features = [
            "arrival_date_full", "total_nights", "total_guests", 
            "with_children", "price_per_person", "price_per_night",
            "booking_season", "has_weekend_stay"
        ]
        for feature in expected_features:
            assert feature in processed_df.columns

    def test_feature_engineering_calculations(self, sample_data, mock_config):
    ...
    def test_data_type_conversions(self, sample_data, mock_config):
    ...
    def test_missing_value_handling(self, data_with_missing_values, mock_config):
    ...
    def test_edge_cases_zero_values(self, mock_config):
    ...
    def test_data_splitting_logic(self, sample_data, mock_config):
        ...
        train_set, test_set = train_test_split(
            ...
            stratify=processed_df[mock_config.target]
        )
