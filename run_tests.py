...
def run_integration_tests(verbose: bool = True) -> int:
    ...
    :return: Exit code from pytest
    """
    cmd = ["python", "-m", "pytest", "tests/test_data_preprocessor.py::TestDataProcessor::test_integration_full_pipeline"]
...
def main():
    ...
    parser.add_argument("--type", choices=["unit", "integration", "all", "quality"], 
