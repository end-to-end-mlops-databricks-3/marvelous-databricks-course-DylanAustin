"""Basic model implementation for hotel reservation cancellation prediction.
...
class BasicModel:
    """A basic model class for hotel reservation cancellation prediction using LightGBM.
    ...
    def __init__(self, config: ProjectConfig, tags: Tags, spark: SparkSession) -> None:
        ...
        self.model_name = f"{self.catalog_name}.{self.schema_name}.hotel_cancellation_model_basic"
        self.tags = tags.dict()
    ...
    def log_model(self) -> None:
        ...
        with mlflow.start_run(tags=self.tags) as run:
            ...
            mlflow.log_param("model_type", "LightGBM Classification with preprocessing")
